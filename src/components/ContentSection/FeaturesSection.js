...
function FeaturesSection() {
  return (
    <article className="text-center text-neuVeryDarkCyan font-openSans text-sm">
      <section>
        <div className="w-full h-[134.22px] bg-stm1 bg-no-repeat bg-bottom bg-full-width">
          {/* div for background top */}
        </div>
        <div className="pt-20 pb-[4.375rem] px-[1.6875rem] bg-neuVeryPaleBlue">
          <img
        ...
        <div className="w-full h-[9.1875rem] bg-sbm1 bg-no-repeat bg-top bg-full-width">
          {/* div for background bottom */}
        </div>
      </section>
      <section className="px-[1.6875rem]">
        <img
      ...
      <section>
        <div className="w-full h-[14.5rem] bg-stm2 bg-no-repeat bg-bottom bg-full-width">
          {/* div for background top */}
        </div>
        <div className="pt-[.4375rem] px-[1.6875rem] pb-28 bg-neuVeryPaleBlue">
          <img
        ...
        <div className="w-full h-[12.5rem] bg-sbm2 bg-no-repeat bg-top bg-full-width">
          {/* div for background bottom */}
        </div>
      </section>
    </article>
